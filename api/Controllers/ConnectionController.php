...
class ConnectionController
{
    ...
    /**
     * Prueba una conexión usando parámetros del formulario, sin guardarla.
     */
    public function testParams(): void
    {
        ...
        $driver = $data['driver'];
        $defaultPort = $driver === 'mysql' ? 3306 : ($driver === 'pgsql' ? 5432 : 1433);
    ...
    private function validate(array $data): array
    {
        ...
        if (empty($data['driver']) || !in_array($data['driver'], ['mysql', 'sqlsrv', 'pgsql'])) {
            $errors[] = 'Driver debe ser mysql, sqlsrv o pgsql';
        }
