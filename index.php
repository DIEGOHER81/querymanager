...
<head>
    ...
    <meta name="description" content="Gestiona, construye y ejecuta consultas SQL contra MySQL, SQL Server y PostgreSQL">
            ...
            <div class="content-area">
                ...
                <div class="panel active" id="panel-connections">
                    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;">
                        <p style="color:var(--secondary);">Administra las conexiones a tus bases de datos MySQL, SQL Server y PostgreSQL.</p>
    ...
    <div class="modal-overlay" id="conn-form">
        <div class="modal">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-success" id="conn-test-btn" onclick="ConnectionsUI.testForm()">Probar conexión</button>
